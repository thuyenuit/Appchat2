    ...
    class AuthUtils {
                    ...
                    .addOnCompleteListener(LoginActivity.this, new OnCompleteListener<AuthResult>() {
                        ...
                        public void onComplete(@NonNull Task<AuthResult> task) {
                            ...
                            if (task.isSuccessful()) {
                                ...
                                {
                                    user.sendEmailVerification();
                                    Toast.makeText(LoginActivity.this, "Địa chỉ email chưa được xác nhận. Vui lòng xác nhận email", Toast.LENGTH_SHORT).show();
                                }
        ...
        void resetPassword(final String email) {
            ...
            if(findIDEmail(email)) {
                ...
                Toast.makeText(LoginActivity.this, "Email " + email + " không tồn tại!" , Toast.LENGTH_SHORT).show();
            }
        }
